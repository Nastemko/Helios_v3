...
def band_start_block_rand_multi_attention_pad(
    ...
    second_product += (1.0 - jnp.minimum(second_seq_pad, second_rand_pad)) * -10000.0
    ...
    first_band_product += (1.0 - jnp.expand_dims(seq_n_pad[:, :, :, :wn], 3)) * -10000.0
    last_band_product += (1.0 - jnp.expand_dims(seq_n_pad[:, :, :, -wn:], 3)) * -10000.0
