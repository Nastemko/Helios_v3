...
ResNet5 = functools.partial(ResNet, stage_sizes=[1], block_cls=BottleneckResNetBlock)
ResNet8 = functools.partial(ResNet, stage_sizes=[1, 1], block_cls=BottleneckResNetBlock)
