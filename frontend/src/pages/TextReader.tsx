    ...
    <div className="flex h-full w-full">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white relative shadow-sm z-0">
        ...
        >
            ...
            {/* AI Mode indicator */}
            {aiModeActive && (
              <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-4 py-2 rounded-full shadow-lg text-sm flex items-center gap-2 z-40">
